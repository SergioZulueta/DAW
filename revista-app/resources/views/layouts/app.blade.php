...
<footer class="footer fixed-bottom p-2">
    <div class="container">
        <span class="text-muted">@JonVadillo | www.jonvadillo.com</span>
    </div>
</footer>
@yield('page-scripts')
</body>
